...
public class UnitTesting {
    ...
    @Test
    void printPeopleNNull() {
        app.printPeople(null, null);
    }

    @Test
    void printPeopleEmpty() {
        ArrayList<Cities> cities = new ArrayList<Cities>();
        ArrayList<Country> countries = new ArrayList<Country>();
        app.printPeople(cities, countries);
        app.printPeople(cities, null);
        app.printPeople(null, countries);
    }

    @Test
    void printPeopleNull() {
        ArrayList<Cities> cities = new ArrayList<Cities>();
        ArrayList<Country> countries = new ArrayList<Country>();
        cities.add(null);
        countries.add(null);
